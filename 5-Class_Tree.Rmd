...
This script presents a binary classification problem using a cell segmentation data set that is included in the package. The data is described in the paper: Hill et al "Impact of image segmentation on high-content screening data quality for SK-BR-3 cells" BMC fioinformatics (2007) vol 8 (1) pp. 340
...
#
## Explore the data
Look at summaries of the variables
```{r}
sapply(dF,summary) 
sapply(dF,class)
```   
